Function Reset-OwnerShipToSystemAdministrators
{
    [CmdletBinding()]
    Param (
        [String]$pathOrFolder
...
"@
    try { add-type $AdjustTokenPrivileges -ErrorAction SilentlyContinue; } catch {}

    #example for testing
    $Folder = Get-Item $pathOrFolder;
    ...
    Write-Verbose "Ownership changed to System Administrators.";

}

#Get-OwnerShip -pathOrFolder 'C:\AccessTest'