function Get-UberBill_USA {
    ...
    $Total_USD_New = [System.Math]::Round($TripFare_USD_New + $Extras_USD_New,2);
...
cls
Get-UberBill_USA -Total_USD 7.74 -Extras_USD 2.65 -Total_INR 574.48 -Miles 3.40 -PercentageIncrement 0.3 `
